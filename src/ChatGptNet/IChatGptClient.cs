...
public interface IChatGptClient
{
    ...
    /// <remarks>This method creates a new conversation with a system message and a random Conversation Id. Then, call <see cref="AskAsync(Guid, string, CancellationToken)"/> or <see cref="AskStreamAsync(Guid, string, CancellationToken)"/> with this Id to start the actual conversation.</remarks>
    ...
    /// <seealso cref="ChatGptRequest"/>
    /// <seealso cref="ChatGptResponse"/>
    IAsyncEnumerable<ChatGptResponse> AskStreamAsync(string message, CancellationToken cancellationToken = default) =>
        AskStreamAsync(Guid.NewGuid(), message, cancellationToken);
    ...
    IAsyncEnumerable<ChatGptResponse> AskStreamAsync(Guid conversationId, string message, CancellationToken cancellationToken = default)
        => AskStreamAsync(conversationId, message, null, cancellationToken);
    ...
    /// <seealso cref="ChatGptRequest"/>
    /// <seealso cref="ChatGptResponse"/>
    IAsyncEnumerable<ChatGptResponse> AskStreamAsync(Guid conversationId, string message, string? model, CancellationToken cancellationToken = default);
