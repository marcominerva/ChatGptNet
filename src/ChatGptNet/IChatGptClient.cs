...
public interface IChatGptClient
{
    ...
    /// <param name="parameters">A <seealso cref="ChatGptParameters"/> object that it's used to override the default completion parameters in the <see cref="ChatGptOptions.DefaultParameters"/></param>
